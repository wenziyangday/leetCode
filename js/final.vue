...
.inner-wrap-content .rx-layout-middle-container:has(.new-pages-search-BNM) {
	background: transparent;
	padding: 0;
	border-radius: 0;
}
.inner-wrap-content .rx-layout-middle-container:has(.new-pages-search-BNM) .rx-fit-content-search .rx-fit-container .rx-fit-head {
	background: #fff;
...
.inner-wrap-content .rx-layout-middle-container:has(.new-pages-search-BNM) .rx-fit-content-search .rx-fit-container .rx-fit-content {
	margin: 0 8px;
}

.inner-wrap-content .rx-layout-middle-container:has(.new-pages-search-BNM) .rx-fit-content-search  .list-toolbar {
	padding: 16px 0 0;
}

.inner-wrap-content .rx-layout-middle-container .new-pages-search-BNM {
	background: #f8f8f9;
...
.condition-onpsb .rx-ant-dropdown-text {
	display: flex;
}

.ant-form-horizontal .x-list-search-box{
